...
class TimeseriesLateral(object):
    ...
    def __init__(self, url=None, simulation=None, offset=None, interpolate=None, values=None, units=None, epsg=None, point=None, connection_node=None, state=None, state_detail=None, node=None, id=None):  # noqa: E501
    ...
    @property
    def node(self):
        """Gets the node of this TimeseriesLateral.  # noqa: E501


        :return: The node of this TimeseriesLateral.  # noqa: E501
        :rtype: int
        """
        return self._node
    ...
    @node.setter
    def node(self, node):
        """Sets the node of this TimeseriesLateral.


        :param node: The node of this TimeseriesLateral.  # noqa: E501
        :type: int
        """
