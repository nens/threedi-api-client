...
class Simulation(object):
    ...
    def __init__(self, url=None, slug=None, uuid=None, name=None, created=None, threedimodel=None, organisation=None, organisation_name=None, user=None, start_datetime=None, end_datetime=None, duration=None, duration_humanized=None, threedimodel_id=None):  # noqa: E501
