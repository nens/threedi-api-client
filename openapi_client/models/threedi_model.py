...
class ThreediModel(object):
    ...
    def __init__(self, url=None, id=None, inpy_version=None, revision=None, revision_hash=None, repository_slug=None, name=None, slug=None, disabled=None, epsg=None, inp_success=None, description=None, storage_space=None, model_ini=None, breach_count=None, extent_two_d=None, extent_one_d=None, extent_zero_d=None, nodes_count=None, lines_count=None):  # noqa: E501
