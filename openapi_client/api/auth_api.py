...
class AuthApi(object):
    ...
    def auth_refresh_token_create(self, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.auth_refresh_token_create_with_http_info(data, **kwargs)  # noqa: E501
            return data
    ...
    def auth_refresh_token_create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        if ('data' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `data` when calling `auth_refresh_token_create`")  # noqa: E501
    ...
    def auth_token_create(self, data, **kwargs):  # noqa: E501
        """Get an API authentication token.  # noqa: E501

        Post username & password to get an \"access\" and \"refresh\" JWT token.  The \"access\" token needs to be sent as HTTP authentication header with every request with a 'Bearer ' prefix (case-sensitive).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.auth_token_create_with_http_info(data, **kwargs)  # noqa: E501
            return data
    ...
    def auth_token_create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        if ('data' not in local_var_params or
                local_var_params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `auth_token_create`")  # noqa: E501
