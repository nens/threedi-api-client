...
class PermissionsApi(object):
    ...
    def permissions_create(self, data, **kwargs):  # noqa: E501
        """Permissions management  # noqa: E501
    ...
    def permissions_partial_update(self, id, data, **kwargs):  # noqa: E501
        """Permissions management  # noqa: E501

        ##Authorization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permissions_partial_update(id, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.permissions_partial_update_with_http_info(id, data, **kwargs)  # noqa: E501
        else:
            (data) = self.permissions_partial_update_with_http_info(id, data, **kwargs)  # noqa: E501
            return data

    def permissions_partial_update_with_http_info(self, id, data, **kwargs):  # noqa: E501
        """Permissions management  # noqa: E501

        ##Authorization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permissions_partial_update_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method permissions_partial_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `permissions_partial_update`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in local_var_params or
                local_var_params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `permissions_partial_update`")  # noqa: E501
    ...
    def permissions_update(self, id, data, **kwargs):  # noqa: E501
        """Permissions management  # noqa: E501

        ##Authorization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permissions_update(id, data, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.permissions_update_with_http_info(id, data, **kwargs)  # noqa: E501
        else:
            (data) = self.permissions_update_with_http_info(id, data, **kwargs)  # noqa: E501
            return data

    def permissions_update_with_http_info(self, id, data, **kwargs):  # noqa: E501
        """Permissions management  # noqa: E501

        ##Authorization  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.permissions_update_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method permissions_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `permissions_update`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in local_var_params or
                local_var_params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `permissions_update`")  # noqa: E501
