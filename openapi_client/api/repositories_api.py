...
class RepositoriesApi(object):
    ...
    def repositories_revisions(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repositories_revisions_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def repositories_revisions_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `repositories_revisions`")  # noqa: E501
    ...
    def repositories_threedimodels(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.repositories_threedimodels_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def repositories_threedimodels_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `repositories_threedimodels`")  # noqa: E501
