...
class ThreedimodelsApi(object):
    ...
    def threedimodels_flow_states_list(self, threedimodel_pk, **kwargs):  # noqa: E501
        """threedimodels_flow_states_list  # noqa: E501

        A simple ViewSet for viewing breaches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.threedimodels_flow_states_list(threedimodel_pk, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.threedimodels_flow_states_list_with_http_info(threedimodel_pk, **kwargs)  # noqa: E501
        else:
            (data) = self.threedimodels_flow_states_list_with_http_info(threedimodel_pk, **kwargs)  # noqa: E501
            return data

    def threedimodels_flow_states_list_with_http_info(self, threedimodel_pk, **kwargs):  # noqa: E501
        """threedimodels_flow_states_list  # noqa: E501

        A simple ViewSet for viewing breaches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.threedimodels_flow_states_list_with_http_info(threedimodel_pk, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method threedimodels_flow_states_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'threedimodel_pk' is set
        if ('threedimodel_pk' not in local_var_params or
                local_var_params['threedimodel_pk'] is None):
            raise ValueError("Missing the required parameter `threedimodel_pk` when calling `threedimodels_flow_states_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/threedimodels/{threedimodel_pk}/flow_states/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def threedimodels_flow_states_read(self, id, threedimodel_pk, **kwargs):  # noqa: E501
        """threedimodels_flow_states_read  # noqa: E501

        A simple ViewSet for viewing breaches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.threedimodels_flow_states_read(id, threedimodel_pk, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: A unique integer value identifying this flow state. (required)
        :param str threedimodel_pk: (required)
        :return: ThreediModelFlowState
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.threedimodels_flow_states_read_with_http_info(id, threedimodel_pk, **kwargs)  # noqa: E501
        else:
            (data) = self.threedimodels_flow_states_read_with_http_info(id, threedimodel_pk, **kwargs)  # noqa: E501
            return data

    def threedimodels_flow_states_read_with_http_info(self, id, threedimodel_pk, **kwargs):  # noqa: E501
        """threedimodels_flow_states_read  # noqa: E501

        A simple ViewSet for viewing breaches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.threedimodels_flow_states_read_with_http_info(id, threedimodel_pk, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method threedimodels_flow_states_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `threedimodels_flow_states_read`")  # noqa: E501
        # verify the required parameter 'threedimodel_pk' is set
        if ('threedimodel_pk' not in local_var_params or
                local_var_params['threedimodel_pk'] is None):
            raise ValueError("Missing the required parameter `threedimodel_pk` when calling `threedimodels_flow_states_read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/threedimodels/{threedimodel_pk}/flow_states/{id}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ThreediModelFlowState',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def threedimodels_rasters_create(self, threedimodel_pk, data, **kwargs):  # noqa: E501
        ...
        A simple ViewSet for viewing raster  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
