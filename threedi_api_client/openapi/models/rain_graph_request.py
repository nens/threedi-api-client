...
class RainGraphRequest(object):
    ...
    def __init__(self, start_time=None, history_points_limit=200, subscribe=None, subscribe_rate_limit=0.5, node_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def subscribe_rate_limit(self, subscribe_rate_limit):
        ...
        :type subscribe_rate_limit: float
        """
        if (self.local_vars_configuration.client_side_validation and
