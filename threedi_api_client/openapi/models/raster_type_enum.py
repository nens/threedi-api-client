...
class RasterTypeEnum(object):
    ...
    def __init__(self, local_vars_configuration=None, fetched_from_api=False):  # noqa: E501
        """RasterTypeEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RasterTypeEnum):
            return False
