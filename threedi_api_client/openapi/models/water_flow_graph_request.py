...
class WaterFlowGraphRequest(object):
    ...
    def __init__(self, start_time=None, history_points_limit=200, subscribe=None, subscribe_rate_limit=0.5, line_id=None, local_vars_configuration=None):  # noqa: E501
