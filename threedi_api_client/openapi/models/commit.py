...
class Commit(object):
    ...
    def __init__(self, commit_message=None, force_as=None, schematisation_name=None, commit_date=None, commit_user=None, user=None, tags=None, local_vars_configuration=None):  # noqa: E501
