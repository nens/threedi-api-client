...
class PersonalAPIKeyWithSecret(object):
    ...
    def __init__(self, prefix=None, scope=None, name=None, expiry_date=None, created=None, revoked=None, last_used=None, key=None, message=None, local_vars_configuration=None):  # noqa: E501
