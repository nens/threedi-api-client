...
class ThreediModelSavedState(object):
    ...
    def variables(self, variables):
        ...
        :type variables: list[SavedStateVariableEnum]
        """
        if (self.local_vars_configuration.client_side_validation and
                variables is not None and len(variables) > 2):
            raise ValueError("Invalid value for `variables`, number of items must be less than or equal to `2`")  # noqa: E501
    ...
    def thresholds(self, thresholds):
        ...
        if (self.local_vars_configuration.client_side_validation and
            ...
            raise ValueError("Invalid value for `thresholds`, number of items must be less than or equal to `2`")  # noqa: E501
