...
class DamagePostProcessing(object):
    ...
    def cost_type(self, cost_type):
        ...
        if self.local_vars_configuration.client_side_validation and cost_type not in allowed_values:  # noqa: E501
            logger.warning(
                "Warning: Unknown value for `cost_type` ({0}), must be one of {1}. Either your threedi-api-client version is out of date or this value is invalid."  # noqa: E501
    ...
    def flood_month(self, flood_month):
        ...
        if self.local_vars_configuration.client_side_validation and flood_month not in allowed_values:  # noqa: E501
            logger.warning(
                "Warning: Unknown value for `flood_month` ({0}), must be one of {1}. Either your threedi-api-client version is out of date or this value is invalid."  # noqa: E501
