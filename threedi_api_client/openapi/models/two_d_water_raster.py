...
class TwoDWaterRaster(object):
    ...
    def aggregation_method(self, aggregation_method):
        ...
        if self.local_vars_configuration.client_side_validation and aggregation_method not in allowed_values:  # noqa: E501
            logger.warning(
                "Warning: Unknown value for `aggregation_method` ({0}), must be one of {1}. Either your threedi-api-client version is out of date or this value is invalid."  # noqa: E501
