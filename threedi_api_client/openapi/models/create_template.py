...
class CreateTemplate(object):
    ...
    def __init__(self, name=None, simulation=None, include_events=True, include_initials=True, include_settings=True, local_vars_configuration=None):  # noqa: E501
