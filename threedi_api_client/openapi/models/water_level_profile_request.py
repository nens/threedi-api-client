...
class WaterLevelProfileRequest(object):
    ...
    def __init__(self, geometry=None, points_limit=100, subscribe=None, subscribe_rate_limit=0.5, local_vars_configuration=None):  # noqa: E501
