...
class NetCDFTimeseriesSourcesSinks(object):
    ...
    def __init__(self, url=None, multiplier=None, simulation=None, offset=None, duration=None, timestamps=None, interval=None, values_reference=None, units=None, file=None, fill_value=None, id=None, uid=None, substances=None, local_vars_configuration=None):  # noqa: E501
